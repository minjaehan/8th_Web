...
export default function MovieCard({movie}:MovieCardProps){
    ...
    return(
        <div
        className='relative rounded-xl shadow-lg overflow-hidden curser-pointer
        ...
        >
            ...
            className=''
             ...
             {isHovered&&(
                <div className='absolute inset-0 bg-gradient-to-t from-block/50
                to-transparent backdrop-blur-md flex flex-col justify-center
                items-enter text-white p-4'>
